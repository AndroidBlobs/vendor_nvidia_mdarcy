...
def cdata(ptr, nelements=1):
    return _nvraw_v3.cdata(ptr, nelements)
cdata = _nvraw_v3.cdata

def memmove(data, indata):
    return _nvraw_v3.memmove(data, indata)
memmove = _nvraw_v3.memmove
...
def INvRawPlaneHeaderReaderV1Cast(*args):
    return _nvraw_v3.INvRawPlaneHeaderReaderV1Cast(*args)
INvRawPlaneHeaderReaderV1Cast = _nvraw_v3.INvRawPlaneHeaderReaderV1Cast
