...
NvctResultImageFormat_Tiff = _nvcameratools.NvctResultImageFormat_Tiff
NvctResultImageFormat_Bmp = _nvcameratools.NvctResultImageFormat_Bmp
...
NvctResultImageFormat_Tiff16 = _nvcameratools.NvctResultImageFormat_Tiff16
...
# set the preview mode as same as still mode
        ...
        print "Picking the preview resolution of %dx%d" % (previewMode.Resolution.width, previewMode.Resolution.height)
...
# set the preview mode same as still mode
        if (self._previewMode !=  None and self._previewMode != self._stillMode):
            ...
            print "Changing the preview resolution to %dx%d" % (stillMode.Resolution.width, stillMode.Resolution.height)

        print "Picking the still resolution of %dx%d" % (stillMode.Resolution.width, stillMode.Resolution.height)
# set jpeg resolution
