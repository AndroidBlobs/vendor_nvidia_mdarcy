...
def NvRawFile_decompress_direct(pLut, lutSize, height, width, pInData, dataFormat, pOutData, pixelFormat):
    return _nvrawfile_pinterface.NvRawFile_decompress_direct(pLut, lutSize, height, width, pInData, dataFormat, pOutData, pixelFormat)
NvRawFile_decompress_direct = _nvrawfile_pinterface.NvRawFile_decompress_direct

def NvRawFile_decompress(pLut, lutSize, height, width, pInData, dataFormat, pOutDataChunk, pixelFormat):
    return _nvrawfile_pinterface.NvRawFile_decompress(pLut, lutSize, height, width, pInData, dataFormat, pOutDataChunk, pixelFormat)
